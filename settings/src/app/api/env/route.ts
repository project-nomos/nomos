...
const ALLOWED_KEYS = [
  ...
  "NOMOS_COMMITMENT_TRACKING",
  "NOMOS_STYLE_MATCHING",
  "NOMOS_EXTRACTION_MODEL",
  "NOMOS_WIKI_ENABLED",
  "NOMOS_WIKI_COMPILE_INTERVAL",
  "NOMOS_WIKI_COMPILE_MODEL",
  "NOMOS_WIKI_MAX_ARTICLES_PER_RUN",
  "NOMOS_API_PROVIDER",
  "OPENROUTER_API_KEY",
  "NOMOS_BROWSER_AUTH",
  "IMESSAGE_ENABLED",
...
const ENV_TO_DB: Record<string, DbMapping> = {
  ...
  NOMOS_COMMITMENT_TRACKING: { table: "config", dbKey: "app.commitmentTracking" },
  NOMOS_STYLE_MATCHING: { table: "config", dbKey: "app.styleMatching" },
  NOMOS_EXTRACTION_MODEL: { table: "config", dbKey: "app.extractionModel" },
  NOMOS_WIKI_ENABLED: { table: "config", dbKey: "app.wikiEnabled" },
  NOMOS_WIKI_COMPILE_INTERVAL: { table: "config", dbKey: "app.wikiCompileInterval" },
  NOMOS_WIKI_COMPILE_MODEL: { table: "config", dbKey: "app.wikiCompileModel" },
  NOMOS_WIKI_MAX_ARTICLES_PER_RUN: { table: "config", dbKey: "app.wikiMaxArticlesPerRun" },
